window.onload = function(){ 
    ...
    .await(function(error, maleFemale, Age) {
        ...
        drawLine(maleFemale, Age, 11, tooltip)
    }); 
}; 


function drawLine(initData, initData2, id, tooltip){
    ...
    var dots = svg.selectAll("circle")
        ...
        .on("click", function(d) {
        // first remove the svg's for bar and pie chart
        ...
        drawPie(initData2, id, tooltip)
        drawBar(initData, id, tooltip)
    };
...
* draw pie chart
*/
function drawPie(initData2, id, tooltip){
    var tooltip = d3.select("body").append("div")
        .attr("class", "tooltip")
        .style("opacity", 0);
...
/*
* update function for bootstrap buttons
*/
function update(id){
    var svg = d3.select("#area3").selectAll("svg").remove();
    var svg = d3.select("#area4").selectAll("svg").remove();
